...
class DashboardController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.dashboard')->with('success', 'Lapangan berhasil ditambahkan');
    }
    ...
    public function update(Request $request, Lapangan $lapangan)
    {
        ...
        return redirect()->route('admin.dashboard')->with('success', 'Lapangan berhasil diperbarui');
    }
    ...
    public function destroy(Lapangan $lapangan)
    {
        ...
        $lapangan->delete();
        return redirect()->route('admin.dashboard')->with('success', 'Lapangan berhasil dihapus');
    }
} 