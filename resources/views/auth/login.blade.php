...
<head>
    ...
    <title>Sports Space - Login</title>
        ...
        <div class="login-card mb-16 w-96 p-8 rounded-2xl z-20">
            ...
            <div class="space-y-4">
                <button class="social-btn flex items-center justify-center px-3 py-3 w-full text-sm font-medium rounded-xl bg-black text-white border border-[#D5CBFF] hover:bg-gray-800">
                    <img src="{{ asset('images/google-icon.png') }}" alt="google" class="w-6 mr-3">
                    Continue with Google
                </button>

                <button class="social-btn flex items-center justify-center px-3 py-3 w-full text-sm font-medium rounded-xl bg-black text-white border border-[#D5CBFF] hover:bg-gray-800">
                    <img src="{{ asset('images/facebook-icon2.png') }}" alt="facebook" class="w-6 mr-3">
            ...
            <div class="relative my-6">
                ...
                <div class="relative flex justify-center text-sm">
                    <span class="px-2 bg-gray-200 text-gray-500">Or continue with email</span>
                </div>
            </div>
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-4">
                ...
                <div class="space-y-2">
                    ...
                    <input type="email" name="email" class="input-field w-full px-4 py-3 text-sm font-medium border border-gray-300 rounded-xl focus:outline-none focus:border-red-500" placeholder="Enter your email" required>
                </div>
    
                <div class="space-y-2">
                    <label class="text-sm font-medium text-gray-700">Password</label>
                    <input type="password" name="password" class="input-field w-full px-4 py-3 text-sm font-medium border border-gray-300 rounded-xl focus:outline-none focus:border-red-500" placeholder="Enter your password" required>
                </div>
    
                <div class="flex items-center justify-between">
                    <label class="flex items-center space-x-2">
                        <input type="checkbox" name="remember" class="rounded-sm border-gray-300 text-red-600 focus:ring-red-500">
                        <span class="text-sm text-gray-600">Remember me</span>
                    </label>
                    <a href="{{ route('password.request') }}" class="text-sm text-red-600 hover:text-red-700">Forgot password?</a>
                </div>
