...
<body class="bg-gray-50">
    ...
    <div class="p-4 sm:ml-64 pt-20">
        <div class="p-4 rounded-lg">
            ...
            <form action="{{ route('sports-group.update', $group->id) }}" method="POST" class="bg-white shadow-md rounded-lg m-2 p-2 w-full">
            @csrf
            @method('PUT')
                ...
                <input type="text" name="title" id="title" value="{{ $group->title }}" placeholder="Group name..." required class="mt-1 mb-2 text-xs w-full rounded-md shadow-md border-gray-300">

                <label for="event_date">Event Date</label>
                <input type="date" name="event_date" id="event_date" value="{{ $group->event_date }}" required class="mt-1 mb-2 text-xs w-full rounded-md shadow-md border-gray-300">

                <label for="start_time">Start Time</label>
                <input type="time" name="start_time" id="start_time" value="{{ $group->start_time }}" required class="mt-1 mb-2 text-xs w-full rounded-md shadow-md border-gray-300">

                <label for="end_time">End Time</label>
                <input type="time" name="end_time" id="end_time" value="{{ $group->end_time }}" required class="mt-1 mb-2 text-xs w-full rounded-md shadow-md border-gray-300">

                <label for="city">City</label>
                <input type="text" name="city" id="city" value="{{ $group->city }}" placeholder="City" required class="mt-1 mb-2 text-xs w-full rounded-md shadow-md border-gray-300">

                <label for="address">Address</label>
                <input type="text" name="address" id="address" value="{{ $group->address }}" placeholder="Detail location..." required class="mt-1 mb-2 text-xs w-full rounded-md shadow-md border-gray-300">

                <label for="kapasitas_maksimal">Maximum Members</label>
                <input type="number" name="kapasitas_maksimal" id="kapasitas_maksimal" value="{{ $group->kapasitas_maksimal }}" placeholder="0" required class="mt-1 mb-2 text-xs w-full rounded-md shadow-md border-gray-300">
                ...
                <select name="jenis_olahraga" required class="mt-1 mb-2 text-xs w-full rounded-md shadow-md border-gray-300 p-2">
                    <option value="{{ $group->jenis_olahraga }}"></option>
                ...
                <input type="number" name="payment_amount" id="payment_amount" value="{{ $group->payment_amount }}" placeholder="0" required class="mt-1 mb-2 text-xs w-full rounded-md shadow-md border-gray-300">
