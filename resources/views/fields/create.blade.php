...
<div class="container mx-auto py-12">
    ...
    <form id="create-lapangan-form" enctype="multipart/form-data" class="bg-white p-6 rounded shadow w-full max-w-xl">
        @csrf
        ...
        <div class="mb-4">
            <label for="foto" class="block font-medium mb-1">Foto Lapangan</label>
            <input type="file" id="foto" name="foto" class="w-full rounded px-4 py-2 border" required>
        </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const form = document.getElementById('create-lapangan-form');
    ...
    form.addEventListener('submit', async e => {
        ...
        try {
            const res = await fetch("{{ url('/api/lapangan') }}", {
                method: 'POST',
                headers: {
            ...
            message.textContent = 'Data berhasil ditambahkan.';
